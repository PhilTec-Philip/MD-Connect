...
nonisolated struct Resources_Settings_BannerMessage: Sendable {
...
nonisolated extension Resources_Settings_BannerMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".BannerMessage"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}title\0\u{1}icon\0\u{1}color\0\u{3}created_at\0\u{3}expires_at\0")
  ...
  static func ==(lhs: Resources_Settings_BannerMessage, rhs: Resources_Settings_BannerMessage) -> Bool {
